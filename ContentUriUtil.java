...
public class ContentUriUtil {
    ...
    public static File getCacheFile(Context context, String dir) {
        File cacheDir = new File(getCachePath(context), dir);
    ...
    private static File createTemporalFileFrom(Context context, InputStream inputStream, String fileName)
        ...
        if (inputStream != null) {
            ...
            //自己定义拷贝文件路径
            targetFile = new File(getCacheFile(context, "cache"), fileName);
